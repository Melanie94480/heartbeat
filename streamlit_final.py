...
pages = {
    "PTB": ["Exploration du DataFrame", "Sélection Patient", "Modèle ML"],
...
if page == "Modèle ML":
    ...
    selected_modele = st.selectbox("Choisissez un modèle ", ("RandomForest", "Regression logistique" , "PYTORCH  avec input : RR ", "PYTORCH  avec inputs : RR + métadonnées ", "autre "))
